...
def main():
    ...
    if os.path.exists(lib) and "pub mod transform;" not in open(lib, encoding="utf-8").read():
        bad.append("lib.rs does not declare `pub mod transform;` — the new tree is unreachable")
