...
//!      Already ported as [`crate::superdsc_opspec::WorkPlan::time_tile_for_lx`]
...
use crate::superdsc_opspec::ItDim;
...
/// of, and NOT to be confused with, [`crate::superdsc_opspec::USABLE_LX_BYTES`] (the on-chip
...
/// `word_bytes`, `stick_elems` elements/stick — [`crate::superdsc_opspec::DataFormat::
...
mod tests {
    ...
    fn cheapest_split_picks_smallest_that_clears() {
        let dim = ItDim {
            ...
            is_reduction: false,
            is_stick: false,
            df: crate::superdsc_opspec::Df::Fp16,
        };
