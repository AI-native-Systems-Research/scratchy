...
pub fn register(d: &mut Dispatch) {
    ...
    d.register(OpKind::MathExp, LatencyCategory::ComputeTranscendental, exp);
    d.register(
        OpKind::MathSqrt,
    ...
    d.register(OpKind::MathLog, LatencyCategory::ComputeTranscendental, log);
    d.register(
        OpKind::MathLog2,
        LatencyCategory::ComputeTranscendental,
        log2,
    ...
    d.register(OpKind::MathSin, LatencyCategory::ComputeTranscendental, sin);
    d.register(OpKind::MathCos, LatencyCategory::ComputeTranscendental, cos);
    d.register(OpKind::MathErf, LatencyCategory::ComputeTranscendental, erf);
    d.register(
        OpKind::MathPowf,
        LatencyCategory::ComputeTranscendental,
        powf,
    ...
    d.register(OpKind::MathAbsf, LatencyCategory::ComputeFloat, absf);
    d.register(OpKind::MathAbsi, LatencyCategory::ComputeFloat, absi);
    d.register(OpKind::MathCeil, LatencyCategory::ComputeFloat, ceil);
    d.register(OpKind::MathFloor, LatencyCategory::ComputeFloat, floor);
    d.register(OpKind::MathFma, LatencyCategory::ComputeFloat, fma);
}
