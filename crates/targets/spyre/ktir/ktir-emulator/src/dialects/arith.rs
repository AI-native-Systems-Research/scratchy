...
pub fn register(d: &mut Dispatch) {
    // Float binary
    d.register(OpKind::ArithAddf, LatencyCategory::ComputeFloat, addf);
    d.register(OpKind::ArithSubf, LatencyCategory::ComputeFloat, subf);
    d.register(OpKind::ArithMulf, LatencyCategory::ComputeFloat, mulf);
    d.register(OpKind::ArithDivf, LatencyCategory::ComputeFloat, divf);
    d.register(OpKind::ArithRemf, LatencyCategory::ComputeFloat, remf);

    // Float unary
    d.register(OpKind::ArithNegf, LatencyCategory::ComputeFloat, negf);
    d.register(OpKind::ArithAbsf, LatencyCategory::ComputeFloat, absf);

    // Float min/max — note `maxf`/`maximumf` and `minf`/`minimumf` are aliases.
    d.register(OpKind::ArithMaxf, LatencyCategory::ComputeFloat, maxf);
    d.register(OpKind::ArithMaximumf, LatencyCategory::ComputeFloat, maxf);
    d.register(OpKind::ArithMaxnumf, LatencyCategory::ComputeFloat, maxnumf);
    d.register(OpKind::ArithMinf, LatencyCategory::ComputeFloat, minf);
    d.register(OpKind::ArithMinimumf, LatencyCategory::ComputeFloat, minf);
    d.register(OpKind::ArithMinnumf, LatencyCategory::ComputeFloat, minnumf);

    // Float comparison
    d.register(OpKind::ArithCmpf, LatencyCategory::ComputeFloat, cmpf);

    // Integer binary
    d.register(OpKind::ArithAddi, LatencyCategory::ComputeInt, addi);
    d.register(OpKind::ArithSubi, LatencyCategory::ComputeInt, subi);
    d.register(OpKind::ArithMuli, LatencyCategory::ComputeInt, muli);
    d.register(OpKind::ArithDivsi, LatencyCategory::ComputeInt, divsi);
    d.register(OpKind::ArithDivui, LatencyCategory::ComputeInt, divui);
    d.register(
    ...
    d.register(OpKind::ArithRemsi, LatencyCategory::ComputeInt, remsi);
    d.register(OpKind::ArithRemui, LatencyCategory::ComputeInt, remui);
    d.register(OpKind::ArithMinsi, LatencyCategory::ComputeInt, minsi);
    d.register(OpKind::ArithMaxsi, LatencyCategory::ComputeInt, maxsi);
    d.register(OpKind::ArithMinui, LatencyCategory::ComputeInt, minui);
    d.register(OpKind::ArithMaxui, LatencyCategory::ComputeInt, maxui);

    // Integer bitwise / shift
    d.register(OpKind::ArithAndi, LatencyCategory::ComputeInt, andi);
    d.register(OpKind::ArithOri, LatencyCategory::ComputeInt, ori);
    d.register(OpKind::ArithXori, LatencyCategory::ComputeInt, xori);
    d.register(OpKind::ArithShli, LatencyCategory::ComputeInt, shli);
    d.register(OpKind::ArithShrsi, LatencyCategory::ComputeInt, shrsi);
    d.register(OpKind::ArithShrui, LatencyCategory::ComputeInt, shrui);

    // Integer comparison (Python uses COMPUTE_FLOAT for cmpi too).
    d.register(OpKind::ArithCmpi, LatencyCategory::ComputeFloat, cmpi);

    // Select
    d.register(OpKind::ArithSelect, LatencyCategory::ComputeFloat, select);

    // Constants & casts (latency-free).
    d.register(OpKind::ArithConstant, LatencyCategory::Zero, constant);
    d.register(OpKind::ArithExtf, LatencyCategory::Zero, extf);
    d.register(OpKind::ArithTruncf, LatencyCategory::Zero, truncf);
    d.register(OpKind::ArithExtsi, LatencyCategory::Zero, extsi);
    d.register(OpKind::ArithExtui, LatencyCategory::Zero, extui);
    d.register(OpKind::ArithTrunci, LatencyCategory::Zero, trunci);
    d.register(OpKind::ArithSitofp, LatencyCategory::Zero, sitofp);
    d.register(OpKind::ArithUitofp, LatencyCategory::Zero, uitofp);
    d.register(OpKind::ArithFptosi, LatencyCategory::Zero, fptosi);
    d.register(OpKind::ArithFptoui, LatencyCategory::Zero, fptoui);
    d.register(OpKind::ArithIndexCast, LatencyCategory::Zero, index_cast);
    d.register(OpKind::ArithIndexCastui, LatencyCategory::Zero, index_cast);
    d.register(OpKind::ArithConvertf, LatencyCategory::Zero, convertf);
    d.register(OpKind::ArithBitcast, LatencyCategory::Zero, bitcast);
}
...
fn constant(
    ...
    let is_tensor = matches!(op.attr(AttrKey::IsTensor), Some(Attr::Bool(true)));
    if is_tensor {
        ...
        let dtype = match op.attr(AttrKey::Dtype) {
            Some(Attr::Dtype(d)) => *d,
            _ => DType::F16,
        };
        let n: usize = shape.iter().product();
        let dense_list = matches!(op.attr(AttrKey::DenseList), Some(Attr::Bool(true)));
...
fn sitofp(
    ...
    let dtype = op.result_type.and_then(IrType::elem).unwrap_or(DType::F32);
...
fn bitcast(
    ...
    // The result type IS the destination — the old `"<src> to <dst>"` spelling had
    // to be split back apart; `IrType` states the destination directly.
    let dst = op
        .result_type
        .and_then(IrType::elem)
        .ok_or("arith.bitcast: missing destination result type")?;
...
fn predicate<'a>(op: &Operation<'a>, name: &str) -> Result<&'a str, String> {
    match op.attr(AttrKey::Predicate) {
