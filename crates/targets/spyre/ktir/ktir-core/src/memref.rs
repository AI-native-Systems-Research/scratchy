...
pub struct MemRef {
    ...
    pub coordinate_set: Option<AffineSet<'static>>,
}
...
pub struct TileRef {
    ...
    pub coordinate_set: Option<CoordinateSet<'static>>,
...
pub enum DimSubscript {
    ...
    DirectExpr { map: AffineMap<'static> },
...
pub struct IndirectAccessTile {
    ...
    pub variables_space_set: AffineSet<'static>,
    /// Iteration order over the variable space; `None` = default.
    pub variables_space_order: Option<AffineMap<'static>>,
