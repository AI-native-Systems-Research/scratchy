...
//! The scheduling and address-placement stage of deeptools — 382 units across 4 modules.
//!
//! `dbo-opt`'s per-program pipeline runs `runDdc` for every program
//! (`dbo/src/Transforms/sdsc_bundle/RunSchedulerOnSdsc.cpp:145`), and `runDdc` is
//! exactly two stages (`dbo/src/Utils/sdsc_bundle/SchedulerStages.cpp:29-41`):
