...
// crustify:todo: e103_totalTripCount
//   authority : dcc/src/Transform/Sentient/OldRegisterInitialization.cpp:198  (15 body lines, level 0)
//   original  : int RegisterInitInfo::totalTripCount(mlir::Operation *op)

// crustify:todo: e104_getRegisterInitPriority
//   authority : dcc/src/Transform/Sentient/OldRegisterInitialization.cpp:214  (36 body lines, level 0)
//   original  : RegisterInitInfo::RegInitLocalePriority RegisterInitInfo::getRegisterInitPriority(mlir::Value val) const

// crustify:todo: e105_weightOfSubset
//   authority : dcc/src/Transform/Sentient/OldRegisterInitialization.cpp:322  (9 body lines, level 0)
//   original  : int RegisterInitInfo::weightOfSubset(const std::vector<mlir::Value> &subset)

// crustify:todo: e106_collectAllRegCoalescingCandidatesImpl
//   authority : dcc/src/Transform/Sentient/OldRegisterInitialization.cpp:340  (18 body lines, level 0)
...
// crustify:todo: e107_hasUniformizeRegion
//   authority : dcc/src/Transform/Sentient/OldRegisterInitialization.cpp:536  (11 body lines, level 0)
