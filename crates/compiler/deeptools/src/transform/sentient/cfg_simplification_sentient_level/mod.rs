...
// crustify:todo: e023_incrementLength
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:293  (1 body lines, level 0)
//   original  : void incrementLength(dcc::WidestIntType increment)

// crustify:todo: e024_incrementIntervalMarker
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:297  (5 body lines, level 0)
//   original  : void incrementIntervalMarker(dcc::WidestIntType increment)

// crustify:todo: e025_getIntervalStride
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:302  (5 body lines, level 0)
//   original  : dcc::WidestIntType getIntervalStride() const

// crustify:todo: e026_changeToDefaultValue
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:316  (6 body lines, level 0)
//   original  : void changeToDefaultValue()

// crustify:todo: e027_print
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:323  (11 body lines, level 0)
//   original  : void print(raw_ostream &OS) const

// crustify:todo: e028_getPrevVal
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:380  (4 body lines, level 0)
//   original  : const EvaluatedValue &getPrevVal() const

// crustify:todo: e029_getEV
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:473  (6 body lines, level 0)
//   original  : const EvaluatedValue &getEV() const

// crustify:todo: e030_isFull
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:527  (5 body lines, level 0)
