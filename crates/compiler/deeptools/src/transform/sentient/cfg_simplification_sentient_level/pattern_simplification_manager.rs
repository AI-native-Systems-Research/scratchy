...
// crustify:todo: e031_populateTable
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:924  (90 body lines, level 0)
...
// crustify:todo: e032_findExistingIterArg
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:1455  (78 body lines, level 0)
//   original  : std::optional<int> PatternSimplificationManager::findExistingIterArg( std::vector<std::tuple<Value, dcc::WidestIntType, dcc::WidestIntType>>::reverse_iterator it_iv, std::vector<std::tuple<Value, dcc::WidestIntType, dcc::WidestIntType>>::reverse_iterator it_end, Operation *inner_for_op, Value target

// crustify:todo: e033_replaceResultByIterArg
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:1541  (8 body lines, level 0)
//   original  : void PatternSimplificationManager::replaceResultByIterArg(Operation *for_op, Value &replacement)

// crustify:todo: e034_replaceIfOpByIterArg
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:1552  (8 body lines, level 0)
//   original  : void PatternSimplificationManager::replaceIfOpByIterArg(Operation *for_op, Value &replacement)

// crustify:todo: e035_replacePredicateIVByIterArg
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:1563  (8 body lines, level 0)
//   original  : void PatternSimplificationManager::replacePredicateIVByIterArg( Operation *for_op, Value &replacement)

// crustify:todo: e036_checkCascadingArgUses
//   authority : dcc/src/Transform/Sentient/CFGSimplificationSentientLevel.cpp:1576  (10 body lines, level 0)
