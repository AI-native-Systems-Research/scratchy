...
// crustify:todo: e056_set
//   authority : dcc/src/Transform/Sentient/LiveRangeReduction.cpp:118  (5 body lines, level 0)
//   original  : void set(SmallVector<int64_t> expr_coeffs, SmallVector<Value> args, affine::FlatAffineValueConstraints cst)

// crustify:todo: e057_print
//   authority : dcc/src/Transform/Sentient/LiveRangeReduction.cpp:141  (14 body lines, level 0)
//   original  : void print(raw_ostream& os)

// crustify:todo: e058_areElementSizeIdentical
//   authority : dcc/src/Transform/Sentient/LiveRangeReduction.cpp:466  (9 body lines, level 0)
//   original  : bool LiveRangeReductionPass::areElementSizeIdentical(Value& lhs, Value& rhs)

// crustify:todo: e059_getFirstGlobalOrConstantAncestor
//   authority : dcc/src/Transform/Sentient/LiveRangeReduction.cpp:1107  (56 body lines, level 0)
//   original  : Value LiveRangeReductionPass::getFirstGlobalOrConstantAncestor( Value val, Region* uniform_region)

// crustify:todo: e060_areReglocalesMatching
//   authority : dcc/src/Transform/Sentient/LiveRangeReduction.cpp:1261  (5 body lines, level 0)
